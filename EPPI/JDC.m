...
%filter =[61,305,610,915,1220,1525]; 
...
writecell(Top100_TP, 'Model analysis-JDC_W/EPPI_gene.csv');

%·Ç¹Ø¼üµ°°×ÖÊ
Top100_ne=setdiff(Top100,Top100_TP);
writecell(Top100_ne, 'Model analysis-JDC_W/EPPI_no_essentialgene.csv');
...
writetable(Topall_rank, 'Model analysis-JDC_W/EPPI_rank.csv');
