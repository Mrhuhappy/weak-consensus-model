...
Top100_TP=importdata('Model analysis-E_POC_W/SPPI6099_gene.csv');
weak_Topall=Pro(inx1(1:number,3));
for i=1:number
    E_POC_W_rank(i,1)=i;
end
list=table(weak_Topall,E_POC_W_rank);

weak_Top100=Pro(inx1(1:100,3));
...
Top100_ne=importdata('Model analysis-E_POC_W/SPPI6099_no_essentialgene.csv');
...
EPPI_rank=readtable('Model analysis-E_POC_W/SPPI6099_rank.csv');
...
writetable(list2, 'Model analysis-E_POC_W/SPPI6099_result.csv');
