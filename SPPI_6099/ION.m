...
writecell(Top100_TP, 'Model analysis-ION_W/SPPI6099_gene.csv');

Top100_ne=setdiff(Top100,Top100_TP);
writecell(Top100_ne, 'Model analysis-ION_W/SPPI6099_no_essentialgene.csv');
...
writetable(Topall_rank, 'Model analysis-ION_W/SPPI6099_rank.csv');
